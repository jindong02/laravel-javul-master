                        ...
                        <div class="list-group-item" style="padding-top:0px;padding-bottom:0px;">
                            <div class="row" style="border-bottom:1px solid #ddd;">
                                <div class="col-sm-7 featured_heading">
                                    <h4 class="colorIssue">{{$areaOfInterestObj->title}}</h4>
                                </div>
                                <div class="col-sm-5 featured_heading text-right colorLightBlue">
                                    <div class="row">
                                        <div class="col-xs-3 text-center">
                                            <a href="{!! url('area_of_interest/'.$areaOfInterestIDHashID->encode($areaOfInterestObj->id).'/edit')!!}">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="control-label colorLightBlue form-control label-value">
                                        @if(!empty($areaOfInterestObj->parent_id))
                                        <a style="font-weight: normal;" class="no-decoration" href="{!! url('area_of_interest/'.$areaOfInterestIDHashID->encode($areaOfInterestObj->parent_id)) !!}">
                                            <span class="badge">{{\App\AreaOfInterest::getName($areaOfInterestObj->parent_id)}}</span>
                                        </a>
                                        @else
                                            -
                                        @endif
